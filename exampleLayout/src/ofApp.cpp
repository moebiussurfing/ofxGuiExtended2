...
void ofApp::setup(){
	...
	ofxGuiGroup2* all = gui.addGroup("all", ofJson({
		{"position", "static"},
		{"height", "100%"},
		{"width", "100%"},
		{"show-header", false},
	...
	// add header group
	ofxGuiGroup2* header = all->addGroup("header", ofJson({
		{"flex-direction", "row"},
		{"show-header", false},
		{"height", 50},
	...
	ofxGuiGroup2* page1 = tabbed_pages->addGroup("page1", ofJson({
...
//	add footer group
	ofxGuiGroup2* footer = all->addGroup("footer", ofJson({
		{"flex-direction", "row"},
		{"show-header", false},
		{"height", 50},
